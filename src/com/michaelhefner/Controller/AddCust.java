...
public class AddCust implements Initializable {
    ...
    private Customer addCustomerToDB(int addressId) throws SQLException {
    ...
    private Address addAddressToDB(int cityId) throws SQLException {
    ...
    private City addCityToDB(int countryId) throws SQLException {
    ...
    private Country addCountryToDB() throws SQLException {
    ...
    private boolean updateCustomerInfo() throws SQLException {
