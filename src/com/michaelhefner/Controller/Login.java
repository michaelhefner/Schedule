...
public class Login implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        if (Locale.getDefault().getLanguage().equals("es")
            ...
            lblUsername.setText(resourceBundle.getString("USERNAME_LABEL"));
            txtUsername.setPromptText(resourceBundle.getString("USERNAME_LABEL"));
            lblPassword.setText(resourceBundle.getString("PASSWORD_LABEL"));
            txtPassword.setPromptText(resourceBundle.getString("PASSWORD_LABEL"));
            lblHeading.setText(resourceBundle.getString("LOGIN"));
